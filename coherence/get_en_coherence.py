...
meta_root = "/cpfs01/shared/public/slimpajama_filter_32k-coherence/"
...
# srun -p llm_o --quotatype=spot --ntasks-per-node=8 --ntasks=8 --cpus-per-task=1 python -u coherence/get_en_coherence.py
